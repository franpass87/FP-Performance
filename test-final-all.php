...
class FinalAllTest
{
    ...
    {
        $this->runFinalAllTest();
    }

    /**
     * Esegue test finale completo
     */
    public function runFinalAllTest(): void
    {
     ...
     */
    private function displayFinalAllResults(): void
    {
...
if (isset($_GET['test_final_all'])) {
    $test = new FinalAllTest();
}
