<?php
/**
 * Test Completo Tutti i Test FP Performance Suite
 * 
...
class AllTestsTest
{
    ...
    {
        echo "<h1>🧪 Test Completo Tutti i Test FP Performance Suite</h1>\n";
...
if (isset($_GET['test_all_tests'])) {
    $test = new AllTestsTest();
}
