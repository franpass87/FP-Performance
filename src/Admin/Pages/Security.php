...
class Security extends AbstractPage
{
    ...
    protected function content(): string
    {
        ...
        echo PageIntro::render(
            '🔒',
            __('Security & .htaccess', 'fp-performance-suite'),
            __('Proteggi il tuo sito con security headers, protezione file sensibili, blocco XML-RPC e regole .htaccess ottimizzate.', 'fp-performance-suite')
        );
        ?>
