<?php
/**
 * Test Principale FP Performance Suite
 * 
...
class MainTest
{
    ...
    /**
     * Esegue test principale
     */
    public function runMainTest(): void
    {
        echo "<h1>🧪 Test Principale FP Performance Suite</h1>\n";
     ...
     */
    private function displayMainResults(): void
    {
        echo "<h2>📊 Risultati Test Principale</h2>\n";
        ...
        echo "<h3>📈 Riepilogo Test Principale</h3>";
        ...
        echo "<p><strong>🎯 Score Principale:</strong> {$score}%</p>";
