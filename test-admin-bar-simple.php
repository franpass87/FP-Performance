<?php
/**
 * Test Semplice Admin Bar Optimization
 * 
 * Verifica la logica delle ottimizzazioni della Admin Bar senza WordPress
 */
...
if (!function_exists('is_admin')) {
    function is_admin() {
        return true; // Simula ambiente admin
    }
}
...
echo "=== TEST SEMPLICE OTTIMIZZAZIONI ADMIN BAR ===\n\n";

// Carica la classe BackendOptimizer
