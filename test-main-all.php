...
class MainAllTest
{
     ...
     */
    public function runMainAllTest(): void
    {
     ...
     */
    private function displayMainAllResults(): void
    {
...
if (isset($_GET['test_main_all'])) {
    $test = new MainAllTest();
}
