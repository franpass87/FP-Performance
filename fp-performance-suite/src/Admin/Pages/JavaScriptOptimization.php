    ...
    protected function content(): string
    {
        ...
        <div class="fp-ps-notice info fp-ps-mb-lg">
            ...
            <div class="fp-ps-notice-content">
                ...
                <p><?php esc_html_e('Riduci il JavaScript non utilizzato e ottimizza il caricamento degli script per migliorare le prestazioni e i Core Web Vitals.', 'fp-performance-suite'); ?></p>
            </div>
        </div>
