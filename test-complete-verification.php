 ...
 * 
 * Test completo di tutte le funzionalità, checkbox e opzioni
 * 
...
class CompleteVerificationTest
{
     ...
     */
    public function runCompleteVerification(): void
    {
     ...
     */
    private function displayCompleteResults(): void
    {
...
if (isset($_GET['test_complete_verification'])) {
    $test = new CompleteVerificationTest();
}
